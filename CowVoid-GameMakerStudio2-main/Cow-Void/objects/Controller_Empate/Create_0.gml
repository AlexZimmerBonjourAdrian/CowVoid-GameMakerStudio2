...
dialogos = [
    ...
    { nombre: "Ribs", sprite: ribs2,      texto: "DEJEN DE HACER RUIDO" },
    { nombre: "Ribs", sprite: ribs2,      texto: "SON LAS 3 DE LA MADRUGADA" },
    ...
    { nombre: "Ribs", sprite: ribs1,      texto: "Ese sonido es muy grave" },
    { nombre: "Ribs", sprite: ribs1,      texto: "No le conozco pero puede evitar hacer tanto ruido?" },
    { nombre: "",    sprite: SpriteVacio, texto: "No tengo razones para cooperar con usted" },
    { nombre: "Ribs", sprite: ribs1,      texto: "?" },
    ...
    { nombre: "Ribs", sprite: ribs1,      texto: "Me estas empezando a dar miedo, ni siquiera te puedo ver" },
