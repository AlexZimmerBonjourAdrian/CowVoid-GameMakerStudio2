...
// Crear naves
with(instance_create_layer(room_width / 2 - 80, room_height - sprite_height / 2 - 80, "Instances", obj_player_1_polo)){
	image_xscale = 0.5;	
	image_yscale = 0.5;

};
with(instance_create_layer(room_width / 2 + 80, room_height - sprite_height / 2 - 80, "Instances", obj_player_2_chicharron)){
	image_xscale = 0.5;
	image_yscale = 0.5;
};
